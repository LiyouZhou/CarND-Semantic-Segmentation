...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # conv1x1 = 
    output = tf.layers.conv2d_transpose(decoder_input, num_classes, 4, strides=(2, 2))

    # skip connections
    decoder_layer1 = tf.add(decoder_input, vgg_layer4_out)
    decoder_layer1_out = tf.layers.conv2d_transpose(decoder_layer1, num_classes, 4, strides=(2, 2))

    decoder_layer2 = tf.add(decoder_layer1_out, vgg_layer3_out)
    decoder_layer2_out = tf.layers.conv2d_transpose(decoder_layer2, num_classes, 16, strides=(8, 8))
