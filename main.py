...
def layers(vgg_layer3_out, vgg_layer4_out, vgg_layer7_out, num_classes):
    ...
    # conv1x1
    vgg_layer7_conv1x1_out = tf.layers.conv2d(vgg_layer7_out, num_classes, 1, 1, padding="SAME")
    vgg_layer4_conv1x1_out = tf.layers.conv2d(vgg_layer4_out_scaled, num_classes, 1, 1, padding="SAME")
...
def run():
    ...
    with tf.Session() as sess:
        ...
        logits, train_op, loss_operation = optimize(layers_output, correct_label, learning_rate, num_classes)
        train_nn(sess,
                 epochs,
                 batch_size,
                 get_batches_fn,
